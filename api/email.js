...
const transporter = nodemailer.createTransport({
  service: "Gmail",
  auth: {
    user: "yohannesgetachew.e@gmail.com", // this should be from env file , email
    pass: "bjlf npye ljfj zehy", // this should be from env file ,Repl with your Gmail password or app-specific password
  },
});
...
app.post("/send-email", (req, res) => {
  ...
  const mailOptions = {
    from: "Ahamenes Space Club <your@gmail.com>", // Sender's name and email address
    to: "itsjohnget@gmail.com", // Replace with your  ahamenes email address
    subject: subject,
    text: message,
  };

  const confirmationOptions = {
    from: "Ahamenes Space Club ",
    to: email,
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                Hello Space Voyager<br></br>
                                                Thank you for The Feedback We're really happy to have you!
                                                 Click the link below to join Ahamenes Space Club :
                                            </div>
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                    ...
                                                    <td align="center" bgcolor="#2F67F6" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;" valign="middle">
                                                        <p style="background:#2F67F6;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                           ...
                                                           <a href="https://t.me/your_telegram_channel" target="_blank" rel="noopener noreferrer" style="color: white; text-decoration: none;">Join our Club</a>
